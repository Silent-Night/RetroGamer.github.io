...
![Thumbnail of RetroGamer](thumbnail.png)

## Usage

To use RetroGamer place all your ROM files in a folder on your phone:
I use a folder named Console Games with sub directories for each console.
